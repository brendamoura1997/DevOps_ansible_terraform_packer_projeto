...
.button5:hover {
    ...
    <body>
     ...
     <form>
            ...
            <button class="button button1"  type="submit" formaction="addUser.php">Adicionar usuário</button>
            <button class="button button2"  type="submit" formaction="searchUser.php">Procurar usuário</button>
